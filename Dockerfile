...
RUN wget http://www-eu.apache.org/dist/tomcat/tomcat-8/v8.0.53/bin/embed/apache-tomcat-8.0.53-embed.tar.gz
RUN tar -zxvf apache-tomcat-8.0.53-embed.tar.gz -C /opt/tomcat --strip-components=1
